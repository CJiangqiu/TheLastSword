...
public class PackHandler {
    ...
    public static void onAddPackFindersEvent(AddPackFindersEvent event) {
        if (event.getPackType().equals(PackType.CLIENT_RESOURCES)) {
            ...
            Path resourcePath = modFile.findResource(new String[]{"resourcepacks", "The Last Sword Classical Texture Pack"});
            ...
            System.out.println("Registering resource pack: " + resourcePath.toString());
